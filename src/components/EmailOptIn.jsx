...
const EmailOptIn = () => {
  ...
  return (
    <Box w="full" mx="auto" bg="white" pt="8" pb="8" color={textColor} textAlign="center" my={6}>
      ...
      <Button size="lg" backgroundColor="#FCFF4B" color="#FCFF4B" _hover={{ bg: "#e7f1ff" }} d="inline-block" verticalAlign="middle" ml={2}>
        Subscribe Now
      </Button>
    </Box>
  );
